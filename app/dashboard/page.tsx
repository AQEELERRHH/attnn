...
export default async function DashboardPage() {
  ...
  return (
    <DashboardClient
      ...
      profile={profile ? { id: profile.id, handle: profile.handle, minBid: profile.minBid, tags: profile.tags, bio: profile.bio, autoAcceptThreshold: profile.autoAcceptThreshold, autoReplyTemplate: profile.autoReplyTemplate ?? null, isActive: profile.isActive, availabilityStatus: profile.availabilityStatus ?? "available", openTo: profile.openTo ?? [] } : null}
      bidderConfig={bidderCfg ? { id: bidderCfg.id, goal: bidderCfg.goal, dailyBudget: bidderCfg.dailyBudget, maxBidPerCreator: bidderCfg.maxBidPerCreator, minFitScore: bidderCfg.minFitScore, searchTags: bidderCfg.searchTags, defaultMessage: bidderCfg.defaultMessage, isActive: bidderCfg.isActive, agentName: bidderCfg.agentName ?? null } : null}
      bids={recentBids.map(b => ({ id: b.id, onChainBidId: b.onChainBidId, bidderUserId: b.bidderUserId, creatorUserId: b.creatorUserId, bidderAddress: b.bidderAddress, creatorAddress: b.creatorAddress, amountUsdc: b.amountUsdc, message: b.message, status: b.status, score: b.score, reply: b.reply, bidTxHash: b.bidTxHash, settlementTxHash: b.settlementTxHash, createdAt: b.createdAt.toISOString(), settledAt: b.settledAt?.toISOString() ?? null, counterOfferAmount: b.counterOfferAmount ?? null, onChainTxHash: b.onChainTxHash ?? null,  settlementOnChainTxHash: b.settlementOnChainTxHash ?? null, agentName: agentNameMap[b.bidderUserId] ?? null }))}
